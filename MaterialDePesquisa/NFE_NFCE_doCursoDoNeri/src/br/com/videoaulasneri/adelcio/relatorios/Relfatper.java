...
public class Relfatper extends JFrame implements ActionListener{
    ...
    public Relfatper(int empresa, Connection conex, String razaoEmpresa, String enderEmpresa, String ambiente){
        try {
    ...
    public void initComponents(){
        try {
            setTitle("Impressão Movimento no Período");
            setSize(400, 240);
            ...
            JOptionPane.showMessageDialog(null, "Relfatper().initComponents() - erro: "+e);
        }
    }
     ...
     public void imprime_fatcli(){
        try{
            ...
            String arquivo = report_dir+"fatper.jasper";  //+"movper.jasper";
...
//JOptionPane.showMessageDialog(null, "Ambiente: " + ambiente);
...
//JOptionPane.showMessageDialog(null, "Executou ViewReport . . . ");
    ...
    public static void main(String args[]) throws SQLException
        ...
        JFrame relfat = new Relfatper(2, null, "", "", "2");
