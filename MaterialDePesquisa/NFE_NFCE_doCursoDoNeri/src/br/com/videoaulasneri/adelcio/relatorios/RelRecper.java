...
public class RelRecper extends JFrame implements ActionListener{
    ...
    public RelRecper(int empresa, Connection conex, String razaoEmpresa, String enderEmpresa, String ambiente){
        try {
            ...
            JOptionPane.showMessageDialog(null, "RelRecper() - erro: "+e);
        }
    }
    ...
    private void initComponents(){
        try {
            setTitle("Impressão Recebimento no Período");
            setSize(400, 240);
            ...
            JOptionPane.showMessageDialog(null, "RelRecper().initComponents() - erro: "+e);
        }
    }
     ...
     private void imprime_recebido(){
        try{
            ...
            String arquivo = report_dir+"recebido.jasper"; 
...
//JOptionPane.showMessageDialog(null, "Executou ViewReport . . . ");
    ...
    public static void main(String args[]) throws SQLException
        ...
        JFrame relfat = new RelRecper(2, null, "", "", "2");
