...
Descrição: Manutenção da Tabela de Tipos de Documento
...
public class Tipo_doc extends JFrame implements ActionListener, MouseListener, KeyListener, FocusListener
{
    int navega = 0;
    ...
    String acaoFiltro;
    JLabel lb_titulo = new JLabel("Manutencao de Cadastro: tipo_doc");
    ...
    public Tipo_doc(int empresa, Connection confat, String razaoEmpresa, String enderEmpresa)
    {
        setTitle("Formulario de Manutencao de Tipos de Documento");
        setSize(1010, 680);
        setLocation(135,85);
        setResizable(true);
    ...
    //Gera cor frente de fundo texfields setBackroundColor()
        ...
        tf_codigo                .setBounds(190,165,31,20);
        label_descricao          .setBounds(100,190,90,20);
        tf_descricao             .setBounds(190,190,120,20);
//Posicao do ultimo cpo da Tabela no Formulario. Utiliz.para Iniciar a exibicao do JTable
        ...
        jTable1.setDefaultRenderer(Object.class, new CellRenderer_tipo_doc());
    ...
    public void preencher_cb_pesquisa(String acaoFiltro){
         ...
         try {
             ...
             if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                  sql_query = "select * from tipo_doc where "
                                 +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
             } else {
                  sql_query = "select * from tipo_doc";
             }
    ...
    public void preencher_jtable(String acaoFiltro)
    {
        ...
        this.acaoFiltro = acaoFiltro;
        //try {
        //    resultset = statement.executeQuery("select * from tipo_doc");
        //} catch (SQLException ex) {
        //    JOptionPane.showMessageDialog(null,"Erro ao listar tipo_doc: "+ex);
        //}
        ...
        try
        {
            ...
            String sqlquery = "";
            if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                sqlquery = "select * from tipo_doc where "
                           +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
            } else {
                sqlquery = "select * from tipo_doc";            }
            ...
            //JOptionPane.showMessageDialog(null,"Qtde regs da tabela: tipo_doc: "+qtreg);
            resultset.last();
        }
...
//Habilita campo chave para inclusao 
        ...
        if (ehnovo)
            ...
            try
            {
                ...
                tf_descricao.setText(tf_descricao.getText().toUpperCase());
                 String sql_insert = "insert into tipo_doc ( "+
                        "codigo, "+"descricao "+")"+
    ...
    public void alterar()
    {
        if (!ehnovo)
        {
            ...
            {
                tf_descricao.setText(tf_descricao.getText().toUpperCase());
                 String sql_alterar = "update tipo_doc set " +"descricao = '"+ tf_descricao.getText()+"'" 
     ...
     public void excluir()
     {
       try
       {
           String nome = "Deletar tipo_doc : "+tf_descricao.getText()+" ?";
           System.out.println("nome = " + nome);
           int opcao_escolhida = JOptionPane.showConfirmDialog(null,nome,"Exclusao ",JOptionPane.YES_NO_OPTION);
           if (opcao_escolhida == JOptionPane.YES_OPTION)
           {
               String  sql_delete = "DELETE FROM tipo_doc Where codigo = '"+ tf_codigo.getText() +"'";
    ...
    public void imprimir()
    {
        ...
        Impressao impr = new Impressao(""+empresa, "tipo_doc.jasper", connection, razaoEmp, enderEmp);
        //Impressao impr = new Impressao(""+empresa, "teste.jasper", connection, razaoEmp, enderEmp);
     ...
     if ( cb_pesquisa.getSelectedItem() != null ){
       try
       {
           ...
           while(!achou)
           {
            ...
            clicado = true;
/*
        String sql = "select * from tipo_doc where Descricao = "+cb_pesquisa.getSelectedItem();
...
*/
    ...
    public void trataEvento_mouse_key_jTable1(){
            ...
            try {
                if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                    String sql_query = "select * from tipo_doc where "
                                +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
    ...
    public static void main(String args[])
        {
        JFrame form = new Tipo_doc(3, null, null, null);
            form.setVisible(true);
    }
}
////classe auxiliar para centralizar as colunas dp JTable
class CellRenderer_tipo_doc extends DefaultTableCellRenderer {
