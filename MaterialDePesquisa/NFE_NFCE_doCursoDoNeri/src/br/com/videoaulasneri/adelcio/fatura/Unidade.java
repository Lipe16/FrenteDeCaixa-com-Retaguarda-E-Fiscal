...
Descrição: Manutenção da Tabela de Unidades de Medida para compor o preço do Produto
...
public class Unidade extends JFrame implements ActionListener, MouseListener, KeyListener, FocusListener
{
    int navega = 0;
    ...
    String acaoFiltro;
    JLabel lb_titulo = new JLabel("Manutencao de Cadastro: unidade");
    ...
    String [] cpo_tabela             = new String[2];
    String [] lab_tabela             = new String[2];

    // criacao de componentes de combobox auxiliares
    String [] tab_cb_tab_box         = new String[2];
    String [] tab_cb_cpo_exibe       = new String[2];
    String [] tab_cb_cpo_assoc       = new String[2];
    JTextField [] tab_cb_tf          = new JTextField[2];
    Statement [] tab_cb_st           = new Statement[2];
    ResultSet [] tab_cb_rs           = new ResultSet[2];
    JComboBox [] tab_cb_cb           = new JComboBox[2];
    boolean stat_aux;
    ...
    public Unidade(int empresa, Connection confat, String razaoEmpresa, String enderEmpresa)
    {
        setTitle("Manutencao da Tabela Unidade");
        setSize(1010, 680);
        setLocation(10,85);
        setResizable(true);
    ...
    //Gera cor frente de fundo texfields setBackroundColor()
        ...
        label_Codigo             .setBounds(100,165,100,20);
        tf_Codigo                .setBounds(200,165,31,20);
        label_Descricao          .setBounds(100,190,100,20);
        tf_Descricao             .setBounds(200,190,160,20);
//Posicao do ultimo cpo da Tabela no Formulario. Utiliz.para Iniciar a exibicao do JTable
        ...
        jTable1.setDefaultRenderer(Object.class, new CellRenderer_unidade());
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent evt) {
                sair();
               // infoSys("Clicou em fechar janela . . .");
    ...
    public void preencher_cb_pesquisa(String acaoFiltro){
         ...
         try {
             ...
             if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                  sql_query = "select * from unidade where "
                                 +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
             } else {
                  sql_query = "select * from unidade";
             }
    ...
    public void preencher_jtable(String acaoFiltro)
    {
        ...
        this.acaoFiltro = acaoFiltro;
        //try {
        //    resultset = statement.executeQuery("select * from unidade");
        //} catch (SQLException ex) {
        //    JOptionPane.showMessageDialog(null,"Erro ao listar unidade: "+ex);
        //}
        ...
        try
        {
            ...
            String sqlquery = "";
            if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                sqlquery = "select * from unidade where "
                           +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
            } else {
                sqlquery = "select * from unidade";            }
            ...
            //JOptionPane.showMessageDialog(null,"Qtde regs da tabela: unidade: "+qtreg);
            resultset.last();
        }
...
//Habilita campo chave para inclusao 
        ...
        if (ehnovo)
            ...
            try
            {
                ...
                tf_Descricao.setText(tf_Descricao.getText().toUpperCase());
                 String sql_insert = "insert into unidade ( "+
                        "Codigo, "+"Descricao "+")"+
                        " values ("+"'"+tf_Codigo.getText() + "', "+"'"+tf_Descricao.getText() + "' " + 
                        ")";
            ...
            catch(SQLException erro)
            {
                 ...
                 JOptionPane.showMessageDialog(null, "Registro jï¿½ existe na Base de Dados!");
            }
         }else
         {
    ...
    public void alterar()
    {
        if (!ehnovo)
        {
            ...
            {
                tf_Descricao.setText(tf_Descricao.getText().toUpperCase());
                 String sql_alterar = "update unidade set " +"Descricao = '"+ tf_Descricao.getText()+"'" 
     ...
     public void excluir()
     {
       try
       {
           String nome = "Deletar unidade : "+tf_Descricao.getText()+" ?";
           System.out.println("nome = " + nome);
           int opcao_escolhida = JOptionPane.showConfirmDialog(null,nome,"Exclusao ",JOptionPane.YES_NO_OPTION);
           if (opcao_escolhida == JOptionPane.YES_OPTION)
           {
               String  sql_delete = "DELETE FROM unidade Where Codigo = '"+ tf_Codigo.getText() +"'";
    ...
    public void imprimir()
    {
        ...
        Impressao impr = new Impressao(""+empresa, "unidade.jasper", connection, razaoEmp, enderEmp);
    ...
    public void trata_cb_auxiliar(Statement st_aux, ResultSet rs_aux, JComboBox cb_aux, JTextField tf_aux, int indice) {
        ...
        try {
 		 ...
 		 try {
                     String sql_aux = "select * from "+tab_cb_tab_box[indice]+" where "+tab_cb_cpo_exibe[indice]+" = ?"; //'"+cb_aux.getSelectedItem()+"'";
                     ps_aux = connection.prepareStatement(sql_aux);
                         ...
                         ps_aux.setString(1, cb_aux.getSelectedItem().toString());
                     System.out.println("Sql_aux: "+sql_aux);
     ...
     if ( cb_pesquisa.getSelectedItem() != null ){
       try
       {
           ...
           while(!achou)
           {
            ...
            clicado = true;
/*
        String sql = "select * from unidade where Descricao = "+cb_pesquisa.getSelectedItem();
...
*/
    ...
    public void trataEvento_mouse_key_jTable1(){
            ...
            try {
                if (acaoFiltro.equals("filtrar") && !tf_pesquisa.getText().equals("")){
                    String sql_query = "select * from unidade where "
                                +cpo_tabela[cb_pesq_lab.getSelectedIndex()]+" like '%"+tf_pesquisa.getText()+"%'";
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getSource() == jTable1){
            ...
            System.out.println("Cï¿½digo da Tecla: "+ e.getKeyCode());
    ...
    public void preenche_cb_auxPesq(Statement st_aux, ResultSet rs_aux, JComboBox cb_aux, JTextField tf_psqAux, int indice) {
        System.out.println("Preenchendo o ComboBox associado ao campo: "+cpo_tabela[indice]);
        try {
            String sql_aux = "";
            cb_aux.removeAllItems();
    ...
    public static void main(String args[])
        {
        JFrame form = new Unidade(3, null, null, null);
            form.setVisible(true);
    }
}
class CellRenderer_unidade extends DefaultTableCellRenderer {
